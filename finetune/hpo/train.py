...
def main():
    ...
    trial_number = training_args.seed - 42
    training_args.seed = 42 # fixed seed across hyperparmeter trials
    ...
    training_args.output_dir = f"{output_dir}/{training_args.run_name}/trial_{trial_number}"
    training_args.logging_dir = f"{logging_dir}/{training_args.run_name}/trial_{trial_number}"
    os.makedirs(training_args.output_dir, exist_ok=True)
    os.makedirs(training_args.logging_dir, exist_ok=True)
    training_args.run_name = training_args.run_name + f"_trial_{trial_number}"
    ...
    with open(training_args.logging_dir + f"/trial_{trial_number}.txt", 'w') as f:
        trial_output = {
